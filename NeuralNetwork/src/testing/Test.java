...
public class Test {
    ...
    public static final String SAVE_PATH = "C:\\Users\\georg\\Documents\\Schule\\SJ1819\\SEW\\NeuralNetwork\\resources\\";

    private static final String NAME = "XORNetV2";
    private static final int TIME = (5 * S);
    ...
    {//generator
        ...
        b1 = r.nextBoolean();
        b2 = r.nextBoolean();
        return new double[][]{{b1 ? 1.0 : 0.0, b2 ? 1.0 : 0.0}, {(b1 ^ b2) ? 1.0 : 0.0}};
    };
    ...
    public static void main(String[] args) {
        ...
        t.startTimedTrainingSession(TIME, (byte) 10);
        //endregion
        //region test
        ...
        for (Pair<Boolean, Boolean> b : bs) {
            ...
            System.out.println("calculated: " + (out[0] < 0.5 ? 0.0 : 1.0) + /*" | " + (out[1] < 0.5 ? 0.0 : 1.0) +/* " | " + (out[2] /*< 0.5 ? 0.0 : 1.0*//*) + " | " + (out[3] /*< 0.5 ? 0.0 : 1.0*//*) + */" | " + "wanted: " + /*((b1 && b2) ? 1.0 : 0.0) + " | " + ((b1 || b2) ? 1.0 : 0.0) + " | " */+((b1 ^ b2) ? 1.0 : 0.0) /*+ " | " + (((!b1 && !b2) || (b1 && b2)) ? 1.0 : 0.0)*/);
        }
        //endregion
        //region save
